...
**Document Purpose:** Master project reference and GreenSyn Accelerator application responses for CylinderIQ (CIQ), ImmersionOS (DIQ), ImmersionIQ (IIQ), TapIQ (TIQ), Safety Assist (SA), Grid Assist (GA), and IQOS (IQ).
...
2. **ImmersionOS (DIQ):** Remote 3.5" touchscreen display (user check-in, usable liters, system status, immersion boost).
...
* **Q8. Technical Solution (250 words):**  
  ...
  Our ecosystem comprises 7 integrated components: **CIQ (CylinderIQ)** sensor hub, **DIQ (ImmersionOS)** touchscreen UI, **IIQ (ImmersionIQ)** dual 20A smart wall controller, **TIQ (TapIQ)** inline smart valve, **SA (Safety Assist)** B2B SaaS monitoring, **GA (Grid Assist)** VPP engine, and **IQOS (IQ)** native applications.  
...
* **Q20. Competitors & Differentiation (150 words):**  
  ...
  *Why We Win:* 1) 15-Minute Low-CAPEX Retrofit: Installs on existing tanks for a fraction of Mixergy's £1,500+ cost; 2) Local Standalone Switching: CIQ hub binds directly to heavy-duty 20A switches; 3) Integrated Safety Moat: Safety Assist offers Legionella compliance, NRV backflow alerts, PRV discharge detection, and leak protection; 4) ImmersionOS UI: High-impact display for residents; 5) In-House Part-P & G3 Plumbing Team ready for immediate field deployment.
...
* **Q26. Anything Else (100 words):** CylinderIQ was born out of hands-on physical hardware experimentation. Backed by an in-house certified installation team (Part-P & G3 plumber), a 3-point pipe sensor array, **ImmersionOS (DIQ)** display UI, pre-certified 20A switching, and an **ImmersionIQ / TapIQ** roadmap, CylinderIQ offers immediate pilot execution readiness for Green Energy Group.
